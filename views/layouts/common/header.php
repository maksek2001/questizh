...
<header>
    <?php
    $icon = '<img src="../../web/images/icons/logo.svg" class="logo">';
    ...
    <ul class="navbar-nav nav">
        <?php if (!Yii::$app->user->isGuest) : ?>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= Url::toRoute('rating/index') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="icon bi bi-building" viewBox="0 0 16 16">
